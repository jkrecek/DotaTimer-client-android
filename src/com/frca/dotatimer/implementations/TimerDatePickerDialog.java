...
public class TimerDatePickerDialog implements DatePickerDialog.OnDateSetListener
{
    ...
    public void onDateSet(DatePicker view, int year, int monthOfYear,int dayOfMonth) {
        ...
        new TimePickerDialog(context, new TimerTimePickerDialog(context, timerPicker),
            timerPicker.get(Calendar.HOUR_OF_DAY), timerPicker.get(Calendar.MINUTE), true).show();
    }
